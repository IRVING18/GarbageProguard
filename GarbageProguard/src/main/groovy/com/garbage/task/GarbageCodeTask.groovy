package com.garbage.task


import com.garbage.template.ManifestTemplate
import com.garbage.template.ResTemplate
...
class GarbageCodeTask extends DefaultTask {
    ...
    @Nested
    GarbageCodeConfig config = new GarbageCodeConfig()
